...
2.  Get a collection of [PropertyDescriptor](https://reference.groupdocs.com/metadata/java/com.groupdocs.metadata.core/PropertyDescriptor) instances for any desired metadata package
