...
weight: 2
description: Supported file formats matrix for GroupDocs.Metadata for Java.
keywords: metadata, supported formats, java
...
GroupDocs.Metadata for Java supports **115+ file formats**. Use the search box below to quickly find your format, or browse by category.
