...
weight: 2
description: Supported file formats matrix for GroupDocs.Metadata for Node.js via Java.
keywords: metadata, supported formats, nodejs-java
...
GroupDocs.Metadata for Node.js via Java supports **115+ file formats**. Use the search box below to quickly find your format, or browse by category.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  {
    "ext": ".cbr",
    "name": "A Comic Book Archive (CBA) file",
    "category": "Archive",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".fb2",
    "name": "A FictionBook 2.0 eBook file",
    "category": "Ebook",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".msg",
    "name": "Microsoft Outlook Mail Message",
    "category": "Email",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".xlsb",
    "name": "Microsoft Excel Binary Spreadsheet",
    "category": "Excel",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".xlsm",
    "name": "Microsoft Excel Open XML Macro-Enabled Spreadsheet",
    "category": "Excel",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".xlsx",
    "name": "Microsoft Excel 2007-2010 Open XML Spreadsheet",
    "category": "Excel",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".xltm",
    "name": "Microsoft Excel Open XML Macro-Enabled Spreadsheet Template",
    "category": "Excel",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".xltx",
    "name": "Microsoft Excel Open XML Spreadsheet Template",
    "category": "Excel",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".otc",
    "name": "OpenType Font Collection File",
    "category": "Font",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".ttc",
    "name": "TrueType Font Collection File",
    "category": "Font",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".cr2",
    "name": "Digital photography RAW format created by Canon",
    "category": "Image",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".dng",
    "name": "Digital Negative Specification",
    "category": "Image",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".heic",
    "name": "High-Efficiency Container Image",
    "category": "Image",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".mpt",
    "name": "Microsoft Project Template File",
    "category": "Other",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".potm",
    "name": "Microsoft PowerPoint 97-2003 Macro-Enabled Presentation Template",
    "category": "PowerPoint",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".potx",
    "name": "Microsoft PowerPoint Open XML Presentation Template",
    "category": "PowerPoint",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".ppsm",
    "name": "Microsoft PowerPoint 2007—2013 Macro-Enabled Presentation",
    "category": "PowerPoint",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".ppsx",
    "name": "Microsoft PowerPoint Open XML Slide Show",
    "category": "PowerPoint",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".pptm",
    "name": "Microsoft PowerPoint 2007—2013 Macro-Enabled Open XML Presentation",
    "category": "PowerPoint",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".vtx",
    "name": "Visio Drawing Template File",
    "category": "Visio",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".docm",
    "name": "Microsoft Word Open XML Macro-Enabled Document",
    "category": "Word",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".dotm",
    "name": "Microsoft Word Open XML Macro-Enabled Document Template",
    "category": "Word",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
  ...
  {
    "ext": ".dotx",
    "name": "Microsoft Word Open XML Document Template",
    "category": "Word",
    "support": {
      "AutoDetection": "✅",
      "Read": "✅",
        ...
        if (matches.length > 0) {
            resultsList.innerHTML = matches.map(match => `
                <div style="padding: 8px; margin: 5px 0; background: #f0f8ff; border-left: 3px solid #007bff; border-radius: 4px;">
                    ...
                    <br><small>Category: ${match.category} | ${match.supportSummary}</small>
                </div>
            `).join('');
