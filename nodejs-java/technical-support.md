...
description: "GroupDocs.Metadata for Node.js provides free technical support available to all users. Please report your question, issue, or feature request using GroupDocs Free Support Forum."
...
* Make sure you are using the latest GroupDocs.Metadata version before reporting an issue. See [NPM](https://www.npmjs.com/package/@groupdocs/groupdocs.metadata) to find out about the latest version.
