...
url: metadata/net/mcp/system-requirements
title: System requirements
weight: 8
description: "The GroupDocs.Metadata MCP server runs anywhere Docker runs, or on any OS with the .NET 10 SDK — this page lists exact requirements per channel and operating system."
...
The GroupDocs.Metadata MCP server runs **anywhere Docker runs**, or on any OS with the **.NET 10 SDK** — pick one channel; you do not need both.
...
AI client requirements: any MCP-compatible client (Claude Desktop, Claude Code, VS Code / GitHub Copilot, Visual Studio 2022 17.14+, Cursor, Windsurf, Cline, Codex CLI) — see [Register in AI clients]({{< ref "metadata/net/mcp/install-in-ai-clients.md" >}}).

The engine's own platform requirements (frameworks, OS versions) are those of the library: [GroupDocs.Metadata system requirements]({{< ref "metadata/net/getting-started/system-requirements.md" >}}).
